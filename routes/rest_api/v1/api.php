...
use App\Http\Controllers\RestAPI\v1\VimeoControllers;

Route::prefix('vimeo')->group(function () {
    // API to handle video upload
    Route::post('/upload', [VimeoControllers::class, 'uploadVideoApi'])->name('api.vimeo.upload');
    Route::get('video/{orderId}', [VimeoControllers::class, 'getVideoByOrderId'])->name('api.vimeo.getVideo');
...
// Route::prefix('vimeo')->group(function () {
//     // Route to handle video upload via API
//     Route::post('/upload-video', [VimeoControllers::class, 'uploadVideoApi']);

//     // Route to get video information via API
//     Route::get('/video/{id}', [VimeoControllers::class, 'getVideoInfo'])->name('api.vimeo.getVideoInfo');
// });



//Route::get('video-messages', [VideoMessageController::class, 'index']);
