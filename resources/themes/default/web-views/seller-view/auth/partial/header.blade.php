    ...
    <div class="">
        <div class="d-flex justify-content-center">
            <div class="ext-center">
                <h3 class="mb-2 text-capitalize">{{$vendorRegistrationHeader?->title ?? translate('celebrity_registration')}}</h3>
                <p>{{$vendorRegistrationHeader?->sub_title ?? translate('create_your_own_login').'.'.translate('already_have_logined').'?'}}
