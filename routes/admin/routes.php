...
use App\Enums\ViewPaths\Admin\RegistrationReason;
...
use App\Http\Controllers\VideomsgController;
//use Illuminate\Support\Facades\Route;
...
Route::get('videos/upload', [VideoController::class, 'showUploadForm'])->name('videos.upload');
Route::post('videos/upload', [VideoController::class, 'store'])->name('videos.store');



Route::get(VimeoAPI::URI->value, [VimeoController::class, 'index'])->name('admin.business-settings.vimeo');
Route::post(VimeoAPI::URI->value, [VimeoController::class, 'update'])->name('admin.business-settings.vimeo.update');
...
//  Route::post('/admin/orders/details/{order_id}/upload-video', [VimeoController::class, 'upload'])->name('upload');

Route::get('/video/{videoId}', [VimeoController::class, 'getVideoInfo']);
Route::get('send-videos', [VimeoController::class, 'sendVideosEmail'])->name('vimeo.sendVideosEmail');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
  ...
  //Route::post('/admin/videomsg/update-heading', [VideomsgController::class, 'updateHeading'])->name('admin.videomsg.updateHeading');


    Route::group(['prefix' => 'videomsg', 'as' => 'videomsg.'], function () {
        Route::controller(VideomsgController::class)->group(function () {
            Route::get(videomsg::LIST[URI], 'index')->name('view');
            Route::post(videomsg::STORE[URI], 'add')->name('store');
            Route::get(videomsg::UPDATE[URI] . '/{id}', 'getUpdateView')->name('update');
            Route::post(videomsg::UPDATE[URI] . '/{id}', 'update')->name('update'); // Ensure route name is specified
            Route::post(videomsg::DELETE[URI], 'delete')->name('delete');
        });
    });
