                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check('product_management'))
                            ...
                            {{-- jkhjkhkhkhh --}}
                            {{-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/videomessage*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.videomsg.view')}}"
                                   title="{{translate('product_Attribute_Setup')}}">
                                   <i class="tio-messages nav-icon"></i>
                                   <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('Video Message')}}</span>
                                </a>
                            </li> --}}
                        @endif
