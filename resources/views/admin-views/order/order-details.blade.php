...
$latestVideoMsg = UserVideoMessage::latest()->first();
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="media align-items-center gap-10">
                                                        <img class="avatar avatar-60 rounded" src="{{ getValidImage(path: 'storage/app/public/product/thumbnail/'.$productDetails->thumbnail, type: 'backend-product') }}" alt="{{translate('image_Description')}}">
                                                        <div>
                                                            <h6 class="title-color">{{substr($productDetails->name, 0, 30)}}{{strlen($productDetails->name)>30?'...':''}}</h6>
                                                    ...
                                                    @if(isset($productDetails->digital_product_type) && $productDetails->digital_product_type == 'ready_after_sell')
                                                        {{-- <button type="button" class="btn btn-sm btn--primary mt-2" title="{{translate('file_upload')}}" data-toggle="modal" data-target="#fileUploadModal-{{ $detail->id }}">
                                                        ...
                                                        <form action="{{ route('admin.orders.digital-file-upload-after-sell') }}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                        ...
                                                                        @if(($product_details->added_by == 'admin') || $detail->seller_id != 1)
                                                                            <div class="inputDnD">
                                                                                <div class="form-group inputDnD input_image input_image_edit" data-title="{{translate('drag_&_drop_file_or_browse_file')}}">
                                                                                    <input type="file" name="digital_file_after_sell" class="form-control-file text--primary font-weight-bold image-input" accept=".jpg, .jpeg, .png, .gif, .zip, .pdf">
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        @include('admin-views.vimeo.view')
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="col-md-9 col-lg-8">
                                ...
                                {{-- <div class="content container-fluid">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h4>Upload Video</h4>
                                        <div>
                                            <button id="local-upload-btn" class="btn btn-primary">Upload to Local</button>
                                            {{-- <button id="vimeo-upload-btn" class="btn btn-secondary">Upload to Vimeo</button> --}}
                                        {{-- </div>
                                    </div> --}} 
                                
                                    {{-- <div id="local-upload-form" class="card">
                                        <div class="card-body">
                                            @include('admin-views.localvideoupload.upload')
                                        </div>
                                    </div> --}}
                                ...
                                @push('script')
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            const vimeoUploadBtn = document.getElementById('vimeo-upload-btn');
                                            const localUploadForm = document.getElementById('local-upload-form');
                                            const vimeoUploadForm = document.getElementById('vimeo-upload-form');
                                
                                            localUploadBtn.addEventListener('click', function () {
                                                localUploadForm.style.display = 'block';
                                                vimeoUploadForm.style.display = 'none';
                                            });
                                
                                            vimeoUploadBtn.addEventListener('click', function () {
                                                vimeoUploadForm.style.display = 'block';
