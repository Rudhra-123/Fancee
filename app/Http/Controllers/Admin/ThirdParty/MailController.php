...
class MailController extends BaseController
{
    ...
    {
        // Construct a TestEmailSender instance
        $video = Video::find($request->video_id); // Assuming you have a way to retrieve the video
        $mail = new TestEmailSender($video);

        // Send the email
        Mail::to("57rudhra@gmail.com")->send($mail);
